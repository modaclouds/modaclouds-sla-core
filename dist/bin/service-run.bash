...
_variable_defaults=(
		...
		_BIN='@{definitions:environment:LIB}/lib/distribution/bin'
		_LIB='@{definitions:environment:LIB}/lib/distribution/lib'
...
_environment+=(
		...
		MODACLOUDS_SLACORE_URL="http://${_SLACORE_PUBLIC_ENDPOINT_IP}:${_SLACORE_ENDPOINT_PORT}"
